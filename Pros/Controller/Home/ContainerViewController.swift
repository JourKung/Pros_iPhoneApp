...
class ContainerViewController: BaseViewController, HomeViewControllerDelegate, UIGestureRecognizerDelegate {
...
//        centerNavigationController.view.addGestureRecognizer(panGestureRecognizer)
    ...
    func addRightPanelViewController() {
        if (rightViewController == nil) {
            ...
            rightViewController!.menu = Menu.allMenu()
...
private extension UIStoryboard {
    ...
    class func centerViewController() -> HomeViewController? {
        return mainStoryboard().instantiateViewControllerWithIdentifier("HomeViewController2") as? HomeViewController
    }
}
